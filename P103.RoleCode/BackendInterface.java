...
public interface BackendInterface {
     ...
     * tree, and to retrieve them by loudness range in the getRange method.
     ...
     * The songs should be ordered by the songs' loudness, and fall within
     ...
     * loudness to include in the returned list.
     *
     ...
     *     are within any previously set loudness range, or an empty list
